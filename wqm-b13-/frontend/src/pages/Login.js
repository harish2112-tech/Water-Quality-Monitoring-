              ...
              <div className="space-y-4">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-black/40 border border-white/10 rounded-[18px] py-4 pl-12 pr-12 text-white placeholder:text-white/20 focus:outline-none focus:border-accent-gold/40 focus:ring-1 focus:ring-accent-gold/20 transition-all duration-500"
                    required
                    disabled={loading}
                  />
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-ocean-light/30 hover:text-accent-gold transition-colors duration-300 focus:outline-none"
                  >
