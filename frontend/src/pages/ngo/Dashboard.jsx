    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center space-x-3 relative">
                    <button
                        ...
                        className={`flex items-center space-x-2 px-4 py-2 border rounded-xl text-sm font-bold transition-all ${statusFilter !== 'all'
                            ...
                            <div className="p-2 flex flex-col space-y-1">
                                {['all', 'active', 'inactive'].map(status => (
                                    <button
                                        ...
                                        className={`text-left px-3 py-2 rounded-lg text-xs font-bold uppercase tracking-wide transition-colors ${statusFilter === status
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Main List Section */}
                <div className="lg:col-span-2 space-y-8">
                    <div className="glass-panel rounded-3xl border border-white/5">
                        <div className="p-6 border-b border-white/5 flex items-center justify-between bg-white/[0.02] rounded-t-3xl">
                            <h2 className="text-lg font-black text-white uppercase tracking-tight">Ongoing Collaborations</h2>
                            <div className="relative">
                                <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-primary-gray" />
                                <input
